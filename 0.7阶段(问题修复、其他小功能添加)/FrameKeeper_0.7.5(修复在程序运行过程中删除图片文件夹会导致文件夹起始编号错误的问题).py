...
class Config:
    ...
    def __init__(self, config_file):
        ...
        self.video_quality = "平衡"  # 默认视频质量为 平衡
...
def open_settings_window(icon):
    ...
    ttk.Button(main_frame, text="保存并关闭", command=save_settings).grid(row=6, column=0, columnspan=3, pady=20)  # 创建保存按钮，放在第 5 行，跨 3 列，上下边距 20 像素
